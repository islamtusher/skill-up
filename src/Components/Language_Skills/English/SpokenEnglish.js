...
const SpokenEnglish = () => {
  ...
  const [content, setContent] = useState(
    "https://www.youtube.com/embed/iVO6C4dVBYg"
  );

  const contents = [
    {
      id: 1,
      title: "Spoken In English Introduction",
      duration: "9.30 minutes",
      contentLink: "https://www.youtube.com/embed/iVO6C4dVBYg",
    },
    {
      id: 2,
  ...
  return (
    <div className="grid grid-cols-3 gap-8 m-24">
      <div className=" border-2 rounded-lg">
        <header className="font-bold text-2xl text-white bg-blue-400 text-center py-4">
           Spoken English Lectures
        </header>
