    ...
    return (
        <div>
            <div className="hero min-h-screen bg-[url('https://mdbootstrap.com/img/new/textures/full/142.jpg')] bg-[50%]">
                ...
                <div className="hero-content flex flex-col lg:flex-row gap-x-10 gap-y-14 pt-20">
                    <div className="max-w-lg text-center lg:text-start">
                        <h1 className='text-6xl md:text-6xl xl:text-7xl text-white font-["Caveat_Brush"] uppercase font-bold'>
                            Develop your skills with <br />
                            <span className="text-secondary">Skill up</span>
                        </h1>
                        <p className="mb-5 text-lg text-white font-[jost]">
