...
const QuizCarousel = () => {
  ...
  return (
    <div className=" quiz-carousel pt-20 px-2 lg:p-20 pb-4 lg:pb-10">
      ...
      <div className=" lg:max-w-[820px] xl:max-w-[1080px]  mx-auto rounded-xl">
        <div className=" lg:max-w-[800px] xl:max-w-[1000px] mx-auto">
          <Slider {...settings} className="flex g-x-4  lg:py-4 px-2">
            <div className="md:p-2 focus:outline-0">
              <img
                className="ocus:border-0 focus:outline-0 rounded-lg transition duration-300 ease-in-out hover:-translate-y-1 hover:cursor-pointer hover:scale-105 "
